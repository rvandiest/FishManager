...
using FishManager.Infrastructure.Repositories;
...
namespace FishManager.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configuration.RootPath = "../FishManager.Presentation/build";
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSpa(spa =>
            {
                spa.Options.SourcePath = "../FishManager.Presentation";
